...
/**
 * Generated class for the SolicitudesAprobadasPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-solicitudes-aprobadas',
  templateUrl: 'solicitudes-aprobadas.html',
})
export class SolicitudesAprobadasPage {
 ...
 public idempleado: number;
  ...
  loadPeople(idEmpleado, buscar) {
    ...
    return new Promise(resolve => {
      ...
      this.solicitudes.getSolicitudesAprobados(idEmpleado, buscar, this.offset)
        .then(data => {
